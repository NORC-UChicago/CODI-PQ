/*******************************************************************************************/
/***PROGRAM: Macro1-CODI_PQ_ZCTA3.SAS									 				 ***/
/***VERSION: 1.0																		 ***/
...
%Macro Generate_ACS_Controls;
	...
	%Let ACSNew=AGE_L5_MALE_WHITE AGE_5_9_MALE_WHITE AGE_10_14_MALE_WHITE AGE_15_17_MALE_WHITE
	...
	Data Census_ACS_Prep;
		Retain Geography State_FIPS STZCTA3 &ACSNew.;
	...
	Proc Sql NOPRINT;
		Create table Census_ACS_Prep_Final as
			...
			select name into :ACS_Full_Var separated by " " from Dictionary.Columns where Libname="WORK" and Memname="CENSUS_ACS_PREP_FINAL" and Name not in ("State_FIPS","Geography","STZCTA3","AGE_25_64_BACH_GRAD_GTR20PERC");
	Quit;
	...
	%Macro Reorient;
		...
		%DO %WHILE(&CURR. NE);
			%If "&Next."^="" %Then %Do;
				select Geography, State_FIPS, STZCTA3, AGE_25_64_BACH_GRAD_GTR20PERC, "&Curr." as ACS_Var, &Curr. as ACS_Count from Census_ACS_Prep_Final union
			%End;
			%Else %Do;
				select Geography, State_FIPS, STZCTA3, AGE_25_64_BACH_GRAD_GTR20PERC, "&Curr." as ACS_Var, &Curr. as ACS_Count from Census_ACS_Prep_Final
			%End;
